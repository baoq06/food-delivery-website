                    ...
                    <div class="food-card"
                        ...
                        <div class="food-body">
                            <div class="food-meta">
                                ...
                                <a href="${pageContext.request.contextPath}/restaurant-detail?id=${food.restaurantId}" class="food-distance" title="${not empty food.restaurantName ? food.restaurantName : 'Quán đối tác'}">
