                            ...
                            <div class="order-card-footer">
                                ...
                                <div class="order-total-action-group">
                                    ...
                                    <div class="order-actions">
                                        ...
                                        <!-- Nút Đánh Giá Đơn Hàng Mới (Chuyển sang trang đánh giá chuyên biệt) -->
                                        <c:if test="${(order.status eq 'DELIVERED' or order.customerConfirmed) and empty order.review}">
                                ...
                                <!-- Trạng thái Đã Đánh Giá (Thanh tóm tắt tinh gọn, bấm vào xem trang chi tiết) -->
                                <c:if test="${(order.status eq 'DELIVERED' or order.customerConfirmed) and not empty order.review}">
                                    <div class="order-review-done-bar">
                                        <div class="review-done-left">
                                            ...
                                            <span class="review-stars-summary">
                                                <span class="score-item"><i class="fa-solid fa-utensils text-danger"></i> Món ăn: <strong>${order.review.foodRating}★</strong></span>
                                        ...
                                        <a href="${pageContext.request.contextPath}/order-review?orderId=${order.id}" class="btn-review-view-detail" title="Xem lại chi tiết nhận xét">
