...
-- 2. Thêm nhà hàng / quán ăn (restaurants)
INSERT INTO `restaurants` (`restaurant_id`, `name`, `description`, `phone`, `address`, `status`, `image_url`) VALUES
(1, 'Bếp Việt Quán', 'Chuyên các món cơm tấm, món Việt đậm đà chuẩn vị quê nhà.', '0901234567', '45 Lê Lợi, Phường Bến Nghé, Quận 1, TP. HCM', 'OPEN', 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=500&auto=format&fit=crop&q=60'),
(2, 'Phở & Bún Gia Truyền 1985', 'Nước dùng ninh xương 24h thanh ngọt, thịt tươi mỗi ngày.', '0902345678', '128 Võ Văn Tần, Phường Võ Thị Sáu, Quận 3, TP. HCM', 'OPEN', 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&auto=format&fit=crop&q=60'),
(3, 'Trà Sữa & Topping Quán', 'Trà sữa đậm vị trà, trân châu dẻo dai nấu mới liên tục.', '0903456789', '88 Sư Vạn Hạnh, Phường 12, Quận 10, TP. HCM', 'OPEN', 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=500&auto=format&fit=crop&q=60'),
(4, 'FastFood King & Snacks', 'Gà rán giòn rụm, Burger phô mai kéo sợi thơm lừng.', '0904567890', '215 Nguyễn Thị Minh Khai, Phường Cầu Ông Lãnh, Quận 1, TP. HCM', 'OPEN', 'https://images.unsplash.com/photo-1552566626-52f8b828add9?w=500&auto=format&fit=crop&q=60');

-- 3. Thêm các món ăn vào bảng foods (kèm ảnh và mô tả để giao diện hiển thị đẹp)
...
(1, 3, 'Nguyễn Văn A', '0912345678', 'Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh', 'Giao tầng trệt toà nhà, ít cay', 110000, 'COD', 'SHIPPING', 1, NOW()),
(2, 4, 'Trần Thị B', '0987654322', 'Phường 22, Quận Bình Thạnh, TP. Hồ Chí Minh', 'Gọi điện trước khi tới 10 phút', 129000, 'QR', 'CONFIRMED', 2, NOW()),
(3, 2, 'Nguyễn Văn Khách', '0987654321', '123 Lê Lợi, P. Bến Nghé, Q.1, TP. HCM', 'Không hành lá trong phở', 75000, 'COD', 'DELIVERED', 1, NOW());
...
(1, 1, 1, 2, 55000, 110000),   -- 2 phần Cơm Tấm Sườn Nướng Mật Ong
(2, 2, 15, 1, 129000, 129000), -- 1 phần Pizza Hải Sản Sốt Pesto
(3, 3, 5, 1, 75000, 75000);     -- 1 tô Phở Bò Tái Nạm Đặc Biệt
